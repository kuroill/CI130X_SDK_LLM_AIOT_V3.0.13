...
extern bool RC_HOST_CALLER(set_doa_out_type(int doa_out_type));
extern void RC_HOST_CALLER(vad_rollback_frm_cfg(short vad_back_frm));
extern void RC_HOST_CALLER(vad_rollback_fast_frm_cfg(short vad_back_frm,bool enable));
extern void RC_HOST_CALLER(req_cmpt_vp)(int type,float* mould_buf,bool* is_ok,float* cos,int cmpt_time, int start_frm,int valid_frm);
